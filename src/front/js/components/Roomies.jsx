...
function Roomies() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
      ...
      <div className="item-center grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="w-4/5 max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-6 bg-white p-12 flex flex-col justify-center items-center h-full rounded-lg">
          <div className="mb-8">
            <img
        ...
        <div className="w-4/5 max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12 bg-white p-12 flex flex-col justify-center items-center h-full rounded-lg">
          <div className="mb-8">
            <img
              className="object-center object-cover rounded-full h-36 w-36"
