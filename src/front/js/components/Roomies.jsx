            ...
            <div className="w-4/5 bg-white p-12 flex flex-col justify-center items-center h-full rounded-t-lg">
                ...
                <div className="text-center">
                    <p className="text-xl text-gray-700 font-bold mb-2">Lucy Carter</p>
                        <button className="min-w-auto w-32 h-10 bg-red-300 p-2 rounded-xl hover:bg-red-500 transition-colors duration-50 hover: ease-out text-white font-semibold">
                         Eliminar
                    </button>
                </div>
            </div>
            <div className="w-4/5 bg-white p-12 flex flex-col justify-center items-center h-full rounded-t-lg">
                Agrega a un nuevo roomie
            </div>
        </div>
    </section>
  );
